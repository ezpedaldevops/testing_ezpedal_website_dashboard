...
const LearnPageSectionNewItemAddForm: React.FC<LearnPageSectionNewItemAddFormProps> = ({
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-[300px] bg-slate-200 xl:px-32 md:px-16 px-4">
      ...
      <button
        ...
        className="mt-4 px-6 bg-[#223658] text-white font-poppins py-2 rounded-xl hover:bg-black transition"
      >
        Add New Item
      </button>
    </div>
